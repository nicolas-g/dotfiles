...
BTC_PRICE_ALERT=37500
ETH_PRICE_ALERT=1250
BCH_PRICE_ALERT=550
...
eth_cmd = "curl -s --retry 5 --retry-delay 15 https://api.coinbase.com/v2/prices/ETH-USD/buy | /usr/local/bin/jq '.data.amount'"
...
bch_cmd = "curl -s --retry 5 --retry-delay 15 https://api.coinbase.com/v2/prices/BCH-USD/buy | /usr/local/bin/jq '.data.amount'"
...
if eth >= ETH_PRICE_ALERT or btc >= BTC_PRICE_ALERT or bch >= BCH_PRICE_ALERT :
    ...
    print("B| color=red")
    print("---")
    print("BTC: ", btc_stdout, "| color=red href=https://coinmarketcap.com/currencies/bitcoin/")
    print("ETH: ", eth_stdout, "| color=red href=https://coinmarketcap.com/currencies/ethereum/")
    print("BCH: ", bch_stdout, "| color=red href=https://coinmarketcap.com/currencies/bitcoin-cash/")
else:
    print("B| color=green")
    print("---")
    print("BTC: ", btc_stdout, "| color=green href=https://coinmarketcap.com/currencies/bitcoin/")
    print("ETH: ", eth_stdout, "| color=green href=https://coinmarketcap.com/currencies/ethereum/")
    print("BCH: ", bch_stdout, "| color=green href=https://coinmarketcap.com/currencies/bitcoin-cash/")
